...
/* clubHead-debug */
function fn_userImg120Error(img) { img.onerror = null; img.src = "http://x.autoimg.cn/club/v1Content/images/Detail/user120_default.gif" } function fn_userImg50Error(img) { img.onerror = null; img.src = "http://x.autoimg.cn/club/v1Content/images/Detail/user50_default.gif" } if (!Array.indexOf) { Array.prototype.indexOf = function (obj) { for (var i = 0; i < this.length; i++) { if (this[i] == obj) { return i } } return -1 } } $(function () { window.setTimeout(function () { var gotop = $("#gotop"); if (gotop.size() == 0) { return } var isIE6 = $.browser.msie && (parseFloat($.browser.version || 6) < 7); var doc = $(window); if (isIE6) { gotop.css("visibility", "hidden").css("display", ""); $(window).bind("scroll touchend", function () { var st = doc.scrollTop(); if (st > 200) { gotop.css("visibility", "visible") } else { gotop.css("visibility", "hidden").css("display", "") } }) } else { $(window).bind("scroll touchend", function () { doc.scrollTop() > 300 ? gotop.fadeIn(300) : gotop.fadeOut(200) }) } }, 2000) }); window.console = window.console || { log: function () { } }; window.autohome = window.autohome || {}; autohome.globalLoginEvents = []; autohome.queryString = {}; autohome.queryString.getName = function (name) { var result = location.search.match(new RegExp("[?&]" + name + "=([^&]+)", "i")); if (result == null || result.length < 1) { return "" } return result[1] }; autohome.UserData = { EL: null, name: location.hostname, init: function () { if (!autohome.UserData.EL) { try { autohome.UserData.EL = document.createElement("INPUT"); autohome.UserData.EL.type = "hidden"; autohome.UserData.EL.style.display = "none"; autohome.UserData.EL.addBehavior("#default#userData"); document.body.appendChild(autohome.UserData.EL); var expires = new Date(); expires.setDate(expires.getDate() + 365); autohome.UserData.EL.expires = expires.toUTCString() } catch (e) { return false } } return true }, setItem: function (key, value) { if (autohome.UserData.init()) { try { autohome.UserData.EL.load(autohome.UserData.name); autohome.UserData.EL.setAttribute(key, value); autohome.UserData.EL.save(autohome.UserData.name); return true } catch (e) { return false } } }, getItem: function (key) { if (autohome.UserData.init()) { try { autohome.UserData.EL.load(autohome.UserData.name); return autohome.UserData.EL.getAttribute(key) } catch (e) { return undefined } } }, remove: function (key) { if (autohome.UserData.init()) { try { autohome.UserData.EL.load(autohome.UserData.name); autohome.UserData.EL.removeAttribute(key); autohome.UserData.EL.save(autohome.UserData.name); return true } catch (e) { return false } } } }; autohome.LocalStore = { get: function (k) { k = String(k); return !window.localStorage ? autohome.UserData.getItem(k) : localStorage.getItem(k) }, set: function (k, v) { k = String(k); return !window.localStorage ? autohome.UserData.setItem(k, v) : localStorage.setItem(k, v) }, remove: function (k) { k = String(k); return !window.localStorage ? autohome.UserData.remove(k) : localStorage.removeItem(k) } }; autohome.cookie = autohome.cookie || {}; autohome.cookie.get = function (key) { var value = autohome.cookie.getRaw(key); if ("string" == typeof value) { value = decodeURIComponent(value); return value } return null }; autohome.cookie.set = function (key, value, options) { autohome.cookie.setRaw(key, encodeURIComponent(value), options) }; autohome.cookie.remove = function (key, options) { options = options || {}; options.expires = new Date(0); autohome.cookie.setRaw(key, "", options) }; autohome.cookie.setRaw = function (key, value, options) { if (!autohome.cookie._isValidKey(key)) { return } options = options || {}; var expires = options.expires; if ("number" == typeof options.expires) { expires = new Date(); expires.setTime(expires.getTime() + options.expires) } document.cookie = key + "=" + value + (options.path ? "; path=" + options.path : "") + (expires ? "; expires=" + expires.toGMTString() : "") + (options.domain ? "; domain=" + options.domain : "") + (options.secure ? "; secure" : "") }; autohome.cookie._isValidKey = function (key) { return (new RegExp('^[^\\x00-\\x20\\x7f\\(\\)<>@@,;:\\\\\\"\\[\\]\\?=\\{\\}\\/\\u0080-\\uffff]+\x24')).test(key) }; autohome.cookie.getRaw = function (key) { if (autohome.cookie._isValidKey(key)) { var reg = new RegExp("(^| )" + key + "=([^;]*)(;|\x24)"), result = reg.exec(document.cookie); if (result) { return result[2] || null } } return null }; autohome.subStr = function (str, size) { if (autohome.getStrSize(str) <= size) { return str } var curSize = 0, arr = []; for (var i = 0, len = str.length; i < len; i++) { arr.push(str.charAt(i)); if (str.charCodeAt(i) > 255) { curSize += 2; if (size === curSize || size === curSize - 1) { return arr.join("") } } else { curSize++; if (size === curSize) { return arr.join("") } } } }; autohome.getStrSize = function (str) { var size = 0; for (var i = 0, len = str.length; i < len; i++) { if (str.charCodeAt(i) > 255) { size += 2 } else { size++ } } return size }; autohome.IsPc = function () { var pform = navigator.platform.toLowerCase(); if (pform.indexOf("macintei") > -1) { return true } if (pform.indexOf("win32") == -1 && pform.indexOf("win64") == -1 && pform.indexOf("windows") == -1) { return false } return true }; autohome.hosts = location.href.indexOf("http://club.new.autohome.com.cn") == -1 ? "http://test.club.autohome.com.cn" : "http://club.new.autohome.com.cn"; if (location.href.indexOf("http://club.autohome.com.cn") != -1) { autohome.hosts = "http://club.autohome.com.cn" } else { if (location.href.indexOf("http://k.autohome.com.cn") != -1) { autohome.hosts = "http://club.autohome.com.cn" } else { if (location.href.indexOf("http://club.daily.autohome.com.cn") != -1) { autohome.hosts = "http://club.daily.autohome.com.cn" } } } autohome.loadLoginUserValue = function () { var clubUserShow = null; autohome.logincookies = { logUserCookies: function () { clubUserShow = autohome.cookie.get("clubUserShow"); clubUserShow = clubUserShow == null ? null : clubUserShow.split("|") }, UN: function () { return clubUserShow ? clubUserShow[3] : "" }, UID: function () { return clubUserShow ? clubUserShow[0] : 0 }, roleId: function () { if (clubUserShow) { return clubUserShow[4] } else { return autohome.cookie.get("Roleid") || -1 } }, isCarOwnerCamp: function () { if (clubUserShow) { return clubUserShow[6] == 1 } else { return autohome.cookie.get("isCarOwnerCamp") == 1 } }, bbsOfMaster: (function () { if (clubUserShow) { return clubUserShow[5] } else { return autohome.cookie.get("bbsOfMaster") } }), picture: function () { if (clubUserShow) { return clubUserShow[7] } else { return autohome.cookie.get("picture") } }, isLogin: function () { return this.UN() && this.UN() != "" && this.UID() > 0 }, userState: function () { var state = clubUserShow && clubUserShow.length >= 10 ? parseInt(clubUserShow[9]) : 0; if (state == NaN) { state = 0 } return state } }; autohome.logincookies.logUserCookies(); autohome.loginUser = { UN: autohome.logincookies.UN(), UID: autohome.logincookies.UID(), roleId: autohome.logincookies.roleId(), isCarOwnerCamp: autohome.logincookies.isCarOwnerCamp(), bbsOfMaster: autohome.logincookies.bbsOfMaster(), picture: autohome.logincookies.picture(), isLogin: autohome.logincookies.isLogin(), UserState: autohome.logincookies.userState() } }; autohome.loadLoginUserValue(); autohome.isBBSMaster = function (bbs) { if (autohome.loginUser.bbsOfMaster != "" && bbs != "") { var s = autohome.loginUser.bbsOfMaster.split(","); for (var i = 0; i < s.length; i++) { if (s[i] == bbs) { return true } } } return false }; autohome.initUser = function () { autohome.loadLoginUserValue(); var un = autohome.loginUser.UN; var uid = autohome.loginUser.UID; var isLogin = autohome.loginUser.isLogin; if (isLogin) { if (autohome.getStrSize(un) > 13) { un = autohome.subStr(un, 9); $(".ico_omit").text("…") } $(".loginUserUrl b").text(un); var isOpen = true; setTimeout(function () { var msgreq = false; if ($.browser.msie) { $(document).bind("focusin", function () { if (!msgreq && event.clientY < 0) { isOpen = true; msgreq = true; setTimeout(function () { msgreq = false }, 100) } }) } else { $(window).bind("focus", function () { if (!msgreq) { isOpen = true; msgreq = true; setTimeout(function () { msgreq = false }, 100) } }) } }, 2000); $("#msgDiv2").click(function () { $(this).hide(); $(this).prev().removeClass("cur") }); function openFun() { isOpen = true } function closeFun() { isOpen = false } if ($.browser.msie) { document.onfocusin = openFun; document.onfocusout = closeFun } else { window.onfocus = openFun; window.onblur = closeFun } $("#nologin").hide(); $(".loginli").show(); if ((autohome.loginUser.roleId > 0 && autohome.loginUser.roleId < 4) || autohome.loginUser.roleId == 30 || autohome.loginUser.roleId == 33) { $("#banwu").show(); $("#guanlihoutai").show(); $("#banzhuxinxi").show(); if (autohome.loginUser.roleId == 3 || autohome.loginUser.roleId == 30) { $("#banzhuqingjia").show() } else { $("#banzhuqingjia").hide() } if (autohome.loginUser.roleId == 2 || autohome.loginUser.roleId == 33) { $("#zhongguanhoutai").show() } else { $("#zhongguanhoutai").hide() } } else { $("#banwu").hide(); $("#guanlihoutai").hide(); $("#banzhuxinxi").hide() } [1, 2, 3, 24, 26, 27, 32, 30, 33].indexOf(parseInt(autohome.loginUser.roleId)) != -1 ? +function () { $("#gwh").show(500) }() : +function () { $("#gwh").hide(300) }(); var qasteamcookiekey = "qasteam" + autohome.loginUser.UID; var teamid = autohome.cookie.get(qasteamcookiekey); if (teamid == null) { $.getScript("http://zhidao.autohome.com.cn/ajax/issteammember", function () { if (qasteam) { if (qasteam.teamid > 0) { $("#qasteam").show() } autohome.cookie.set(qasteamcookiekey, qasteam.teamid, { expires: 3 * 60 * 60 * 1000 }) } }) } else { if (teamid > 0) { $("#qasteam").show() } } } else { autohome.head.LoginDivInit(); $("#nologin").show(); $(".loginli").hide(); $("#banwu").hide() } }; autohome.head = autohome.head || {}; autohome.head.wrap = $(".pop_forum"); autohome.head.content = $(".pf_cont"); autohome.head.back = $("#back"); autohome.head.liulanheight = 0; autohome.head.logindiv = $(".pop_login"); autohome.head.showdiv = null; autohome.head.wrapChange = function () { var wrap = autohome.head.showdiv; var scrolltop = $(document).scrollTop(); if (wrap != null) { var screenWidth = $(window).width(); var screenHeight = $(window).height(); var objLeft = (screenWidth - wrap.width()) / 2; var objTop = (screenHeight - wrap.height()) / 2 + scrolltop; var isIE6and7 = navigator.userAgent.toLowerCase().indexOf("msie 6") > -1 || navigator.userAgent.toLowerCase().indexOf("msie 7") > -1; if (!isIE6and7 && (wrap == autohome.head.wrap || $(wrap).attr("class") == $(autohome.head.wrap).attr("class"))) { wrap.css("position", "fixed"); wrap.css("z-index", "100100"); wrap.css("top", "80px"); wrap.css("left", objLeft) } else { wrap.css("position", "absolute"); wrap.css("z-index", "100100"); wrap.css("top", objTop); wrap.css("left", objLeft) } autohome.head.back.css("position", "absolute"); autohome.head.back.css("height", $(window).height()); autohome.head.back.css("top", scrolltop) } }; autohome.MasklayerIsShow = function (state) { if (state) { autohome.head.showdiv.show(); autohome.head.back.show(); autohome.head.liulanheight = $(document).scrollTop(); autohome.head.wrapChange() } else { autohome.head.showdiv.hide(); autohome.head.back.hide(); autohome.head.showdiv = null } }; autohome.head.noFixed = function () { $("#headDiv").css("position", "absolute") }; autohome.head.LoginDivInit = function () { var regUrl = "http://account.autohome.com.cn/register?backUrl=" + escape(document.URL); var loginErr = $("#loginErr"); var headRegAEl = $("a[lang='headRegA']"); headRegAEl.attr("href", regUrl); var loginPwd = $("#loginPwd"); loginPwd.val(""); var codediv = $("dl[class='pl_from pl_tv']"); var vagueCodeA = $("#vagueCodeA"); var loginValidateCodeimg = $("#loginValidateCodeimg"); vagueCodeA.click(function () { if (vagueCodeA.text() == "显示验证码") { vagueCodeA.text("看不清，换一张"); loginValidateCodeimg.show() } loginValidateCodeimg.attr("src", "http://account.autohome.com.cn/validatecode/getvalidatecode?r=" + Math.random()) }); loginValidateCodeimg.click(function () { vagueCodeA.click() }); var loginErrCnt = 0; function getLoginErrCnt() { $.ajax({ type: "get", cache: false, url: "http://account.autohome.com.cn/validatecode/AddValidateCodeJsonp", data: { callback: "jsonpValidateCode" }, dataType: "jsonp", jsonp: "callback", jsonpCallback: "jsonpValidateCode", success: function (data) { loginErrCnt = data.result; if (loginErrCnt == 1) { codediv.show(); vagueCodeA.click() } else { codediv.hide() } } }) } var loginName = $("#loginName"); if (autohome.loginUser.UN != "") { loginName.val(autohome.loginUser.UN) } else { loginName.val(loginName.attr("lang")) } loginName.keypress(function () { loginErr.text(""); $(this).css("color", "#000") }); loginName.focus(function () { if ($(this).val() == $(this).attr("lang")) { $(this).val("") } }); var loginValidateCode = $("#loginValidateCode"); loginValidateCode.keypress(function (event) { loginErr.text(""); event = (event) ? event : ((window.event) ? window.event : ""); var keyCode = event.keyCode ? event.keyCode : (event.which ? event.which : event.charCode); if (keyCode == 13) { $("#loginSubmit").click() } }); autohome.isFristLogin = true; autohome.loginClickhandler = function (source) { if (source != "detail") { window.location = "http://account.autohome.com.cn?backUrl=" + escape(location.href); return } getLoginErrCnt(); if (autohome.isFristLogin) { autohome.isFristLogin = false; var script = document.createElement("script"); script.src = "http://x.autoimg.cn/club/v1Content/js/md5.js"; document.getElementsByTagName("head")[0].appendChild(script) } autohome.head.showdiv = autohome.head.logindiv; autohome.MasklayerIsShow(true) }; $("#loginSubmit").click(function () { var name = loginName.val(); var pwd = loginPwd.val(); var validateCode = loginValidateCode.val(); if (name == "" || name == loginName.attr("lang")) { loginName.focus(); loginErr.text("账户不能为空"); return } if (pwd == "") { loginPwd.focus(); loginErr.text("密码不能为空"); return } else { if (pwd.length < 6 || pwd.length > 25) { loginErr.text("账户密码不匹配"); loginPwd.focus(); return } } if (loginErrCnt >= 5) { if (validateCode == "") { loginErr.text("验证码不能为空"); loginValidateCode.focus(); return } else { if (validateCode.length != 4) { loginErr.text("验证码不正确"); loginValidateCode.focus(); return } } } loginErr.text("登录中，请稍候…"); var isSave = false; if ($("#loginIsSave").attr("checked")) { isSave = true } $.ajax({ type: "Post", cache: false, url: "http://account.autohome.com.cn/login/validindexjsonp", data: { name: escape(name.replace(/\+/gi, "%2B")), pwd: hex_md5(pwd), validcode: validateCode, isauto: isSave, t: "json", callback: "jsonpvalidindexjsonp" }, dataType: "jsonp", jsonp: "callback", jsonpCallback: "jsonpvalidindexjsonp", success: function (data) { var json = data; if (json.success == "0") { getLoginErrCnt(); loginErr.text(json.MsgTxt) } else { try { autohome.autohomeJsLoad({ url: json.LoginUrl, f: "" }) } catch (e) { } if (autohome.login.loginCallBack) { autohome.initUser(); autohome.MasklayerIsShow(false); autohome.login.loginCallBack(); if (autohome.globalLoginEvents && autohome.globalLoginEvents.length > 0) { $.each(autohome.globalLoginEvents, function (i, e) { try { $.isFunction(e) && e() } catch (ex) { } }) } } else { autohome.MasklayerIsShow(false); setTimeout("location.reload();", 1000) } } } }) }); $("#headlogin").click(function () { autohome.loginClickhandler() }); loginPwd.keydown(function (event) { loginErr.text(""); if (event.keyCode == 13) { $("#loginSubmit").click() } }); $("label[for=auto]").bind("click", function () { $("#loginIsSave")[0].checked = !$("#loginIsSave")[0].checked }) }; autohome.go_otherclub_key = "go_otherclub_key_"; autohome.go_otherclub_time = "go_otherclub_time_"; autohome.head.init = function () { if (!autohome.IsPc()) { autohome.head.noFixed() } function openel() { $(".open").hover(function () { var el = $(this); el.children(":first").addClass("cur"); $(".t_layer", el).show() }, function () { var el = $(this); el.children(":first").removeClass("cur"); $(".t_layer", el).hide() }) } var wrap = autohome.head.wrap; var content = autohome.head.content; var back = autohome.head.back; autohome.initUser(); openel(); $(window).resize(autohome.head.wrapChange); $(window).scroll(autohome.head.wrapChange); if (location.href.indexOf("i.autohome.com.cn") > -1) { $("li[lang='headgc']").show(); $("li[lang='headyy']").show() } else { $("li[lang='headgc']").show(); $("li[lang='headyy']").show(); $(".ico_close").click(function () { autohome.MasklayerIsShow(false) }); $(".pf_tab a").click(function () { content.html('<p style="margin-left: 20px;">正在努力加载。。。</p>'); var url = "http://ajax.club.autohome.com.cn" + $(this).attr("alink").toLowerCase(); if (url.indexOf("allbbs") > -1) { url += "?rnd=" + Math.random(); $.ajax({ type: "get", cache: false, url: url, data: { callback: "jsonpCallbackclub" }, dataType: "jsonp", jsonp: "callback", jsonpCallback: "jsonpCallbackclub", success: function (data) { content.html(data.html) } }) } else { var k = ""; if (url.indexOf("seariesbbs") > -1) { k = "c" } else { if (url.indexOf("areabbs") > -1) { k = "a" } else { if (url.indexOf("themebbs") > -1) { k = "o" } } } var json = autohome.LocalStore.get(autohome.go_otherclub_key + k); var time = autohome.LocalStore.get(autohome.go_otherclub_time + k); if (!json || time == null || new Date(parseInt(time) + 24 * 3600 * 1000) < new Date()) { $.ajax({ type: "get", cache: false, url: url, data: { callback: "jsonpCallbackckclub1" }, dataType: "jsonp", jsonp: "callback", jsonpCallback: "jsonpCallbackckclub1", success: function (data) { autohome.LocalStore.set(autohome.go_otherclub_key + k, data.html); autohome.LocalStore.set(autohome.go_otherclub_time + k, new Date().getTime()); content.html(data.html) } }) } else { content.html(json) } } $("a", $(this).parent()).removeClass("cur"); $(this).addClass("cur"); return false }); $("#btn_otherclub").attr("href", 'javascript:autohome.head.showdiv = autohome.head.wrap;$(".pf_tab .cur").click();autohome.MasklayerIsShow(true)') } var seachEl = $("#headsearch"); var btnEl = $("#headbtn"); var cache = []; seachEl.keypress(function () { this.style.color = "#000" }); seachEl.keydown(function (event) { if (event.keyCode == 13) { } }); seachEl.focus(function () { seachEl.parent().addClass("t_search_cur"); if (cache["x-y-z"]) { Sou.Autocomplate.AddAutocomplate("headsearch", "autocomplateTip") } else { $.getScript("http://x.autoimg.cn/club/v1Content/js/ssr20161128.js?r=2014031815170", function () { cache["x-y-z"] = 1; Sou.Autocomplate.AddAutocomplate("headsearch", "autocomplateTip") }) } }); seachEl.blur(function () { var el = $(this); if (el.val() == "") { seachEl.parent().removeClass("t_search_cur") } }); btnEl.click(function () { if (seachEl.val().replace(/(^\s*)|(\s*$)/g, "") != "" && seachEl.val().replace(/(^\s*)|(\s*$)/g, "") != seachEl.attr("lang")) { document.getElementById("headQueryForm").submit() } return false }) }; autohome.autohomeJsLoad = function (args) { var s = document.createElement("script"); s.setAttribute("type", "text/javascript"); s.setAttribute("src", args.url); s.onload = s.onreadystatechange = function () { if (!this.readyState || this.readyState == "loaded" || this.readyState == "complete") { s.onload = s.onreadystatechange = null; try { s.parentNode && s.parentNode.removeChild(s) } catch (e) { } if (args.f == "init") { } } }; document.getElementsByTagName("head")[0].appendChild(s) }; autohome.login = function (cb, source) { if (cb) { autohome.login.loginCallBack = cb } if (!autohome.loginUser.isLogin) { autohome.loginClickhandler(source) } }; autohome.head.init(); autohome.loadScript = function (js, callback) { var __script = document.createElement("script"); __script.type = "text/javascript"; __script.setAttribute("defer", "defer"); if (__script.readyState) { __script.onreadystatechange = function () { if (__script.readyState == "loaded" || __script.readyState == "complete") { __script.onreadystatechange = null; if (callback) { callback() } } } } else { __script.onload = function () { if (callback) { callback() } } } if (js) { __script.src = js } document.getElementsByTagName("head")[0].appendChild(__script) }; seajs.config({ version: "201406301340", base: "http://x.autoimg.cn/as/js-2.0.2/", alias: { "popmobilebind": "http://x.autoimg.cn/account/scripts/poplogin/popmobilebind.js", "popUpNickName": "http://x.autoimg.cn/account/Scripts/poplogin/PopUpNickName.js", "popLogin": "http://x.autoimg.cn/account/Scripts/poplogin/PopLoginV2.js", "md5": "http://x.autoimg.cn/account/Scripts/poplogin/Popmd5.js", "dialog": "http://x.autoimg.cn/account/Scripts/poplogin/dialog.js", "jquery": "http://x.autoimg.cn/as/js-2.0.2/jquery.js" } }); var _seajs = seajs; autohome.UserValidate = function (type, callback) { type = type || 0; if (!autohome.loginUser.isLogin) { _seajs.use(["popLogin", "dialog", "jquery", "md5"], function (popLogin, dialog) { window._domain = document.domain; document.domain = "autohome.com.cn"; window.closeAccountPop = function (success) { dialog.hide(); if (success != 0) { try { document.domain = window._domain } catch (e) { } } }; window.callBackFunAccountPopLogin = function () { autohome.initUser(); if (window.tz) { if (window.tz.ksReplyLoginZoneAfterCreateHandler) { window.tz.ksReplyLoginZoneAfterCreateHandler(editor) } if (window.tz.ksReplyUserProfileRefresh) { window.tz.ksReplyUserProfileRefresh() } } if (callback) { callback({ oState: -1 }) } try { document.domain = window._domain } catch (e) { } }; popLogin.init(type, document.location.href) }); return false } else { if (type != 0 && autohome.loginUser.UserState == 1) { _seajs.use(["popmobilebind", "dialog", "jquery", "md5"], function (popmobilebind, dialog) { window._domain = document.domain; document.domain = "autohome.com.cn"; window.closeAccountPop = function (success) { dialog.hide(); if (success != 0) { try { document.domain = window._domain } catch (e) { } } }; window.callBackFunAccountBind = function () { autohome.loadLoginUserValue(); if (window.tz) { if (window.tz.ksReplyLoginZoneAfterCreateHandler) { window.tz.ksReplyLoginZoneAfterCreateHandler(editor) } if (window.tz.ksReplyUserProfileRefresh) { window.tz.ksReplyUserProfileRefresh() } } if (callback) { callback({ oState: 1 }) } try { document.domain = window._domain } catch (e) { } }; popmobilebind.init() }); return false } else { if (type != 0 && autohome.loginUser.UserState == 2) { _seajs.use(["popUpNickName", "dialog", "jquery", "md5"], function (popNick, dialog) { window._domain = document.domain; document.domain = "autohome.com.cn"; window.closeAccountPop = function (success) { dialog.hide(); if (success != 0) { try { document.domain = window._domain } catch (e) { } } }; window.callBackFunAccountPopUpNick = function () { autohome.initUser(); if (window.tz) { if (window.tz.ksReplyLoginZoneAfterCreateHandler) { window.tz.ksReplyLoginZoneAfterCreateHandler(editor) } if (window.tz.ksReplyUserProfileRefresh) { window.tz.ksReplyUserProfileRefresh() } } if (callback) { callback({ oState: 2 }) } try { document.domain = window._domain } catch (e) { } }; popNick.init() }); return false } else { return true } } } };
/* other */
if (!String.prototype.format) {
    String.prototype.format = function () { var args = arguments; var regex = /\{(\d+)\}/g; return this.replace(regex, function (m, i) { return args[i] }) }
    /* http://x.autoimg.cn/club/v1Content/js/index/i.min.js?201404021345  */
} if (!Array.prototype.indexOf) { Array.prototype.indexOf = function (obj, start) { for (var i = (start || 0), j = this.length; i < j; i++) { if (this[i] === obj) { return i } } return -1 } } function substr(str, len, end) { if (!str || !len) { return "" } var a = 0, i = 0; var temp = ""; for (i = 0; i < str.length; i++) { if (str.charCodeAt(i) > 255) { a += 2 } else { a++ } if (a > len) { return temp + end } temp += str.charAt(i) } return str } (function (n) { var t = {}, u = ['<a target="_blank" href="/bbs/forum-{0}-{1}-1.html" title="{2}" {3}>{2}{4}</a>', '<ul class="forum-list">{0}</ul>', '<p>{0}</p><ul class="forum-list02">{1}</ul>'], f = [new RegExp(/[A-Za-z]/), new RegExp(/^980\d{3,}$/ig)], i = null; function r(n, t, y, r) { if (["c", "a", "o"].indexOf(n) != -1 && (t == "" || f[0].test(t))) { if (!r) { clearTimeout(i); i = setTimeout('_club.initialDatas("' + n + '","' + t + '","' + y + '",1)', 100); return 0 } var merge = {}, _f = f; var e = { "type": n, "exttype": y, "initial": t }; $.post("/clubindex/indexv2?" + (new Date).getTime(), e, function (i) { var r, f, e; i = $.parseJSON(i); r = []; i.length > 0 ? $.each(i, function (t, f) { r = y == "0" ? (merge[f.brand_name] = merge[f.brand_name] || []) : (merge["none"] = merge["none"] || []); var __a = "", __b = ""; _f[1].test(f.TypeId || f.bbsid) ? +function () { __a = 'class="first-a"', __b = "<span><i></i></span>"; r.splice(0, 0, u[0].format(n, f.TypeId || f.bbsid, f.Name || f.bbsname, __a, __b)) }() : r.push(u[0].format(n, f.TypeId || f.bbsid, f.Name || f.bbsname, __a, __b)) }) : (merge["none"] = merge["none"] || []).push("<li>\u6682\u65e0\u6570\u636e</li>"); var _fr = _analyzeHtml(merge, y === "0"); _fr.length > 0 && (f = n + ":" + y + ":" + (t == "" ? "\u70ed\u95e8" : t), e = _fr.join(""), _club.getCache(f) || _club.setCache(f, e), function () { var _a = $("#_" + n).parent(); var _b = _a.find("div.forum-brand-box"); var _c = _a.find("div.forum-list-box"); y === "0" ? _c.hide(150) && _b.html(e) && _b.show(300) : _b.hide(150) && _c.html(e) && _c.show(300) }(), f = null, e = null, r = null) }, "json"); return 1 } else { return -1 } } function _analyzeHtml(m, t) { var _fr = []; if (t) { $.each(m, function (t, f) { var r = []; f && $.each(f, function (i, k) { i === 0 && r.push("<li>"); i > 0 && i < f.length && i % 5 == 0 && r.push("</li><li>"); r.push(k); i === f.length - 1 && r.push("</li>") }); _fr.push(u[2].format(t == "none" ? "" : t, r.join(""))) }) } else { var r = []; $.each(m["none"], function (i, k) { i === 0 && r.push("<li>"); i > 0 && i < m["none"].length && i % 5 == 0 && r.push("</li><li>"); r.push(k); i === m["none"].length - 1 && r.push("</li>") }); _fr.push(u[1].format(r.join(""), "", "")) } return _fr } var _inicials = $("#_inicial_hack").attr("data-val").split(","); $("#_c,#_a,#_o").on("click", "a", _tabDataLoad); function _tabDataLoad() { if ($(this).attr("data-type") == "tips") { $(this).parent().parent().hide(); return } if ($(this).hasClass("btn-disabled")) { return } var n = $(this).parent(), u = n.attr("id").substr(1), i = $(this).text(), f, e; if (i === "\u8F66\u7CFB\u62FC\u97F3" || i === "\u54C1\u724C\u62FC\u97F3") { $(n).find("a[data-type=py]").removeClass("btn-blue"); $(this).addClass("btn-blue"); if (i === "\u8F66\u7CFB\u62FC\u97F3") { $(n).find("a[data-type!=py]").each(function () { $(this).removeClass("btn-disabled") }) } else { if (i === "\u54C1\u724C\u62FC\u97F3") { $(n).find("a[data-type!=py].btn").each(function (i, k) { var _tmp = $(this).text(); if (_tmp == "\u70ed\u95e8") { $(this).addClass("btn-disabled").addClass("btn-clear-blue") } else { if (_inicials.indexOf(_tmp) == -1) { $(this).addClass("btn-disabled") } } }) } } } else { $(n).find("a[data-type!=py]").removeClass("btn-current"); $(n).find("a[data-type!=py]:first").removeClass("btn-blue").removeClass("btn-clear-blue"); $(n).find("a[data-type!=py]:first").toggleClass(function () { return i === "\u70ed\u95e8" || i === "\u5168\u90e8" ? "btn-blue" : "btn-clear-blue" }); i === "\u70ed\u95e8" || i === "\u5168\u90e8" || $(this).addClass("btn-current") } var _extType = $(n).find("a[data-type=py].btn-blue:first").text() === "\u54C1\u724C\u62FC\u97F3" ? "0" : "1"; var _b = n.parent().find("div.forum-brand-box"); var _c = n.parent().find("div.forum-list-box"); f = _extType === "0" ? _b : _c; i = $(n).find("a[data-type!=py]").filter(".btn-current:first,.btn-blue:first").text(); e = u + ":" + _extType + ":" + i; var hk = u + ":" + _extType + ":" + $(n).find("a[data-type!=py]:first").text(); t[e] ? (_extType === "1" ? _b.hide(150) : _c.hide(150), $(f).html(t[e]), _extType === "1" ? _c.show(300) : _b.show(300)) : (_extType === "0" && (t[hk] || (t[hk] = $(f).html())), t[e] || r(u, i == "\u70ed\u95e8" ? "" : i, _extType) < 0 ? (_extType === "1" ? _b.hide(150) : _c.hide(150), $(f).html(t[e]), _extType === "1" ? _c.show(300) : _b.show(300)) : null); n = null; u = null; i = null; f = null; e = null } n.initialDatas = r; n.setCache = function (n, i) { t[n] = i }; n.getCache = function (n) { return t[n] }; var _fptips = autohome.cookie.get("fptips"); _fptips || $("#_tips").show(300); $("#_tips").on("click", function () { autohome.cookie.set("fptips", "1", { expires: 31536000000, domain: "club.autohome.com.cn", path: "/" }) }); var _fptips_mc = autohome.cookie.get("fptips_mc"); _fptips_mc || $("#_tips_mc").show(300); $("#_tips_mc").on("click", function () { $(this).hide(); autohome.cookie.set("fptips_mc", "1", { expires: 31536000000, domain: "club.autohome.com.cn", path: "/" }) }); $(function ($) { $('a[data-type="py"].btn-blue:first').click() }) })(_club), function () { function i() { var t = n.val().replace(/(^\s*)|(\s*$)/g, ""); return t !== "" && t != n.attr("lang") && t !== n.attr("data-val") && ($("#headsearch").val(n.val()), document.getElementById("headQueryForm").submit()), !1 } var t = [], n = $("#search_text"), r = $("#search_btn"); n.focus(function () { $(n).val() === $(n).attr("data-val") && $(n).val(""); t.a_b_c ? Sou.Autocomplate.AddAutocomplate("search_text", "search_tips") : _club.loadScript(document, "http://x.autoimg.cn/club/v1Content/js/ssr20161128.js?201404151629", null, function () { t.a_b_c = 1; Sou.Autocomplate.AddAutocomplate("search_text", "search_tips") }) }); $(n).on("blur", function () { $(n).val() === "" && $(n).val($(n).attr("data-val")) }); $(n).on("keydown", function (n) { n.keyCode === 13 && i() }); r.click(i) }(_club), (function () { var patterns = [new RegExp(/(?:([coa]{1})\-(\d+)\|([^,"\|]+)),?/i)], i = ['<a target="_blank" href="/bbs/forum-{0}-{1}-1.html" title="{3}">{2}</a>'], _ct = $("#ftb_c"), _max = 5, n = function () { var _hdata = _loadHistory(), _fr = [], _sort = {}; if (autohome && autohome.loginUser && autohome.loginUser.UID && autohome.loginUser.UID > 0) { $.getJSON("http://msi.autohome.com.cn/ajax/collection/getobjids?callback=?", { "userid": autohome.loginUser.UID, "typeids": "2,3,4" }, function (data) { var offset = -1; data && $.each(_hdata, function (o, p) { data.indexOf(parseInt(p.bbsid)) != -1 && (_sort[p.bbsid] = offset--) }); _sort && _hdata.sort(function (a, b) { var _a = _sort[a.bbsid] || 0, _b = _sort[b.bbsid] || 0; if (_a > _b) { return 1 } if (_a < _b) { return -1 } return 0 }); _fr = _commonUsedWrapper(_hdata); _fr && _fr.length > 0 && _ct.hide(), _ct.html(_fr.join("|")), _ct.slideDown(15) }) } else { _fr = _commonUsedWrapper(_hdata); _fr && _fr.length > 0 && _ct.hide(), _ct.html(_fr.join("|")), _ct.slideDown(15) } }; n(); function _commonUsedWrapper(data) { var _result = [], _distinct = [], r = []; data && $.each(data, function (o, p) { var _n = p.bbsname.indexOf("\u8bba\u575b") != -1 ? p.bbsname : p.bbsname + "\u8bba\u575b"; _result.push(i[0].format(p.bbs, p.bbsid, substr(_n, 12, ""), _n)) && _distinct.push(_n) }) && data.length < _max && $("#ftb_c-data>a").each(function (n, t) { if (r.length > _max) { return false } if (_distinct.indexOf($(t).text()) == -1) { r.push($(t).prop("outerHTML")) } }) && _result.push(r.slice(0, Math.min(r.length, _max - data.length)).join("|")); return _result.slice(0, _max) } function _loadHistory() { var _data = autohome.cookie.get("historybbsName4"); var _tmp = null; var _result = []; _data && patterns[0].test(_data) && (_tmp = _data.split(",")); _tmp && $.each(_tmp, function (i, k) { var match = patterns[0].exec(k); match && match.length > 3 && _result.push({ "bbs": match[1], "bbsid": match[2], "bbsname": match[3] }) }); return _result.reverse() } })(_club); (function (o) { var _cache = { brands: [], series: {} }, _tpi = 1, _tpiMax = 0, _seriesIds = [], _tpl = ['<li><em><a target="_blank" title="{0}" href="/bbs/thread-{1}-{2}-{3}-1.html#pvareaid=2237104">{4}</a></em><span class="username"><a target="_blank" title="{5}" href="http://i.autohome.com.cn/{6}">{7}</a></span><span class="bbsname"><a target="_blank" href="/bbs/forum-{8}-{9}-1.html">{10}</a></span><span>{11}</span></li>']; (function () { var _ = jQuery.event.special, A = "evt_v" + (+new Date()), $ = "evt_v" + (+new Date() + 1); _.scrollstart = { setup: function () { var $, B = function (A) { var C = this, B = arguments; if ($) { clearTimeout($) } else { A.type = "scrollstart"; jQuery.event.handle.apply(C, B) } $ = setTimeout(function () { $ = null }, _.scrollstop.latency) }; jQuery(this).bind("scroll", B).data(A, B) }, teardown: function () { jQuery(this).unbind("scroll", jQuery(this).data(A)) } }; _.scrollstop = { latency: 500, setup: function () { var A, B = function ($) { var C = this, B = arguments; if (A) { clearTimeout(A) } A = setTimeout(function () { A = null; $.type = "scrollstop"; jQuery.event.handle.apply(C, B) }, _.scrollstop.latency) }; jQuery(this).bind("scroll", B).data($, B) }, teardown: function () { jQuery(this).unbind("scroll", jQuery(this).data($)) } } })(); function _loadAllBrands(cb) { _cache.brands.length == 0 ? $.getScript("/ajax/getallbrands?" + new Date().getTime(), function () { allbrands && allbrands.returncode == 0 && allbrands.result.branditems && allbrands.result.branditems.length > 0 && function () { _cache.brands = allbrands.result.branditems; cb != null && cb() }() }) : cb != null && cb() } function _loadAllSeries(id, cb) { typeof (_cache.series[id]) == "undefined" || _cache.series[id].length == 0 ? $.getScript("/ajax/getseriesbybrandid?brandid={0}".format(id), function () { series && series.returncode == 0 && series.result.seriesitems && series.result.seriesitems.length > 0 && function () { _cache.series[id] = series.result.seriesitems; cb != null && cb() }() }) : cb != null && cb() } function _prepareAllBrands() { var _i = $("#_b>dl:first"); _i.children().size() == 0 && _loadAllBrands(function () { var _result = { letter: [], html: [] }; $.each(_cache.brands, function (i, k) { _result.letter.indexOf(k.bfirstletter) == -1 ? function () { _result.letter.push(k.bfirstletter); _result.html.push("<dt>{0}</dt>".format(k.bfirstletter)); _result.html.push('<dd data-val="{1}"><a href="javascript:void(0);" title="{2}">{0}</a></dd>'.format(k.name, k.id, k.name)) }() : function () { _result.html.push('<dd data-val="{1}"><a href="javascript:void(0);" title="{2}">{0}</a></dd>'.format(k.name, k.id, k.name)) }() }); _result.html.length > 0 && function () { _result.letter.length = 0; _i.html(_result.html.join("")) }() }) } function _prepareAllSeries(id) { var _i = $("#_s>dl:first"); _i.children().size() == 0 && _loadAllSeries(id, function () { var _result = { html: ['<dd data-val="0"><a href="javascript:void(0);" title="全部车系">全部车系</a></dd>'] }; $.each(_cache.series[id], function (i, k) { _result.html.push('<dd data-val="{1}"><a href="javascript:void(0);" title="{2}">{0}</a></dd>'.format(k.name, k.id, k.name)) }); _result.html.length > 0 && function () { _i.html(_result.html.join("")) }() }) } function _timeLineLabel(t) { var result = "", ts = Math.abs(Math.ceil((new Date().getTime() - eval("new " + (t.replace(/\//g, ""))).getTime()) / 1000)); if (ts < 0) { ts = 0 } if (ts < 60) { result = "{0}秒前".format(ts) } else { if (ts > 60 && ts < 3600) { result = "{0}分钟前".format(Math.ceil(ts / 60)) } else { if (Math.ceil(ts / 3600) >= 1 && Math.ceil(ts / 3600) < 24) { result = "{0}小时前".format(Math.ceil(ts / 3600)) } else { if (Math.ceil(ts / 86400) >= 1) { result = "{0}天前".format(Math.ceil(ts / 86400)) } } } } return result } function _stsFigure() { if (_tpiMax) { return } _load_pos.text("加载中..."); _load_pos.show(); var _p = $(window).height() * 2 / 3, _s = $(window).scrollTop(), _h = $(document).height(), _min = Math.max(0, _s - _p), _max = Math.min(_h, _s + _p), _t = _load_pos.offset().top - _p / 2; _t >= _min && _t < _max && function () { _tpi = Math.max(1, _tpi); _loadEssentialTopics() }() } var _ets = $("#_ets"), _load_pos = $("#load_pos"), _pageSize = 35; function _loadEssentialTopics() { if (_tpiMax) { _load_pos.hide(); return } if (_tpi == 1 && _seriesIds.length == 0) { _pageSize = 70 } else { _pageSize = 35 } var _r = []; $.getJSON("/ajax/essentialtopics?pageindex={0}&seriesids={1}&pagesize={2}".format(_tpi, _seriesIds.join(","), _pageSize), function (k) { k.data && k.data.length > 0 && function () { $.each(k.data, function (i, o) { o.bbsName = (o.bbsName.indexOf("\u8bba\u575b") != -1 ? o.bbsName : o.bbsName + "\u8bba\u575b"); _r.push(_tpl[0].format(o.tTitle, o.tBBS, o.tBBSId, o.topicId, substr(o.tTitle, 58, "..."), o.tmemberName, o.tMemberId, substr(o.tmemberName, 12, "..."), o.tBBS, o.tBBSId, o.bbsName, _timeLineLabel(o.tRefineTime))) }) }(); if (_r.length == 0) { ++_tpiMax; if (_tpi == 1) { _r.push("<li>这个车系暂时还没有精华帖，您可以动手写一篇或者先看看其它车系的。</li>") } } if (_tpi == 1 && _seriesIds.length == 0) { _ets.empty(); ++_tpi } _r.length > 0 && _ets.append(_r.join("")); _load_pos.hide(); ++_tpi }) } var _b = $("#_b"), _b_opt = $("#_b_opt"), _b_fist = _b_opt.find(">span:first"), _s = $("#_s"), _s_opt = $("#_s_opt"), _s_fist = _s_opt.find(">span:first"), _ets_btn = $("#_ets_btn"); $(window).bind("scrollstop", function (e) { _stsFigure() }); _b.on("click", "a", function () { var _t = $(this), _p = $(this).parent(), _v = _p.attr("data-val"); _b_fist.text(_t.text()); _b_fist.attr("data-val", _v); _b.hide(); _s_fist.text("\u9009\u62E9\u8F66\u7CFB"); _s_fist.attr("data-val", -1); _s.find(">dl:first").empty(); _prepareAllSeries(_v) }); _s.on("click", "a", function () { var _t = $(this), _p = $(this).parent(), _v = _p.attr("data-val"); _s_fist.text(_t.text()); _s_fist.attr("data-val", _v); _s.hide() }); _b_opt.on("click", function () { _s.hide(); _prepareAllBrands(); _b.toggle() }); _s_opt.on("click", function () { _b.is(":hidden") && _s.toggle() }); _ets_btn.on("click", function () { var _a = parseInt(_b_fist.attr("data-val")), _b = parseInt(_s_fist.attr("data-val")); if (_a == -1) { alert("选择品牌"); return } if (_b == -1) { alert("选择车系"); return } _seriesIds = []; if (_b == 0) { _s.find(">dl:first>dd").each(function (i, k) { var _v = parseInt($(this).attr("data-val")); _v != 0 && _seriesIds.push(_v) }) } else { _seriesIds.push(_b) } _load_pos.text("加载中..."); _load_pos.show(); _tpi = 1; _tpiMax = 0; _ets.empty(); _loadEssentialTopics(); _club.clickStatis("1|3|1|0|200029|300024") }); var unique = (function () { var time = (new Date()).getTime() + "-", i = 0; return function () { return time + (i++) } })(); o.imgLog = function (url) { var data = window["imgLogData"] || (window["imgLogData"] = {}); var uid = unique(); var img = data[uid] = new Image(); img.onload = img.onerror = function () { img.onload = img.onerror = null; img = null; delete data[uid] }; img.src = url + (url.indexOf("?") != -1 ? "&" : "?") + "ts=" + uid }; o.clickStatis = function (eid) { var url = "http://pv.alert.autohome.com.cn/click_count.php?eid={0}&val=1&rurl={1}&curl={2}&ctime={3}".format(eid, encodeURIComponent(document.referrer), encodeURIComponent(document.location.href), new Date().getTime()); _club.imgLog(url) } })(_club);