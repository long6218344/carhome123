...
(function () {
	var html_like = '<div class="pop_read_like J_pop_like" style="">\
								<div class="hd"><a id="J_like_close" href="" class="pop_close">�ر�</a><span id="J_like_m"><a href="index.blade.php?m=like&c=mylike">����ϲ��</a></span></div>\
								<!--���ǰ-->\
								<div class="ct" id="J_like_trigger">\
									<input type="text" class="input" placeholder="˵��ʲô�ɡ�" />\
								</div>\
								<!--�����-->\
								...
								<div id="J_like_enter" style="display:none;">\
									...
									<div class="ft">\
										...
										<button class="btn" type="submit" id="J_like_forwarding_sub">ȷ��</button><label><input type="checkbox" name="isfresh" value="1" />�����ҵķ�˿</label>\
									</div>\
								</div>\
								</form>\
								<!--����-->\
