...
<div class="wrap">
                            ...
                            <div id="J_head_user_menu" role="menu" class="header_menu_wrap my_menu_wrap" style="display:none;">
                                <div class="header_menu my_menu cc">
                                    ...
                                    <ul class="ct cc">
                                        ...
                                        <li><a href="#"><em class="icon_medal"></em>我的勋章</a></li>
                                    </ul>
                                    <ul class="ft cc">
            ...
            <div class="leftside">
                <div class="left index-left" id="left">
                    ...
                    <div class="menuBox" id="menuBox">
                        <h4>消息</h4>
                        <ul class="item">
                            <li class=""><a class="ico_xx01" href="{{url('/home/message-write/2/'.$_SESSION['uid'])}}">私信</a></li>
                        ...
                        <ul class="item">
                            ...
                            <li class=""><a class="ico_yy08" href="#">我的权限</a></li>
                            <li class=""><a class="ico_yy01" href="#">我的积分</a></li>
    ...
    <div class="footer_wrap" style="margin-top: 20px;width:100%">
        <div class="footer">
