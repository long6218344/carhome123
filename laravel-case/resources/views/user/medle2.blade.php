                    ...
                    <div class="box_wrap medal_page">
                        <nav>
                            <div class="content_nav">
                                <ul>
                                    <li ><a href="{{url(asset('/user/medle'))}}">我的勋章</a></li>

                                    <li class="current"><a href="{{url(asset('/user/medle2'))}}">勋章中心</a></li>
                                        ...
                                        @if(count($image)==0)
                                            ...
                                            @foreach($image as $v)
                                                ...
                                                <li class="ct" style="float:left;margin:20px">
                                                    ...
                                                    <button class="btn {$use[$name['medal_id']]}" type="submit"  name="sub" disabled >已领取</button>
                                            ...
                                            {{--<foreach name="medalss" item="medal">--}}
                                                {{--<li style="position:relative;z-index:1;">--}}
                                                    {{--<a data-role="show" data-id="15" class="J_medal_card" href="#">--}}
                                                        {{--<img src="__PUBLIC__/uploads/big/a_{$medal['image']}" width="96" height="96" alt="" class="imgs" />--}}
                                                    ...
                                                    {{--<div class="core_pop" style="min-width:200px">--}}
                                                        ...
                                                        {{--<div class="ct J_content" >--}}
                                                            {{--<form class="J_medal_pop_form" method="post" action="#">--}}
                                                                {{--<dl class="cc">--}}
                                                                    {{--<dt id="J_medal_pop_img">--}}
                                                                        {{--<img width="96" height="96" src="__PUBLIC__/uploads/big/a_{$name['image']}">--}}
                                                                    {{--</dt>--}}
                                                                    {{--<dd >--}}
                                                                        {{--<p>--}}
