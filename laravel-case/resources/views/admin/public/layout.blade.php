            ...
            <ul class="nav ace-nav" >
                ...
                <li class="green">
                    ...
                    <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="#">
                                <img src="{{asset('imgs/avatar.png')}}" class="msg-photo" alt="Alex's Avatar" />
                                <span class="msg-body">
                        ...
                        <li>
                            <a href="#">
                                <img src="{{asset('/imgs/avatar3.png')}}" class="msg-photo" alt="Susan's Avatar" />
                                <span class="msg-body">
											<span class="msg-title">
                        ...
                        <li>
                            <a href="#">
                                <img src="/imgs/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
                                <span class="msg-body">
											<span class="msg-title">
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li>
                    <a href="#" class="dropdown-toggle">
                        <i class="icon-desktop"></i>
                        <span class="menu-text"> 管理组管理 </span>
        ...
        <div class="ace-settings-container" id="ace-settings-container" style="opacity:0;">
...
<script src="{{asset('/js/admin/typeahead-bs2.min.js')}}"></script>
...
<![endif]-->
<script src="{{asset('/js/admin/jquery-ui-1.10.3.custom.min.js')}}"></script>
<script src="{{asset('/js/admin/jquery.ui.touch-punch.min.js')}}"></script>
<script src="{{asset('/js/admin/jquery.slimscroll.min.js')}}"></script>
<script src="{{asset('/js/admin/jquery.easy-pie-chart.min.js')}}"></script>
<script src="{{asset('/js/admin/jquery.sparkline.min.js')}}"></script>
<script src="{{asset('/js/admin/flot/jquery.flot.min.js')}}"></script>
<script src="{{asset('/js/admin/flot/jquery.flot.pie.min.js')}}"></script>
<script src="{{asset('/js/admin/flot/jquery.flot.resize.min.js')}}"></script>
