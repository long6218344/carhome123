        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a href="{{url('/admin/photo')}}"><button class="btn btn-success">返回相册列表</button></a>
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">

                    <form action="{{url('/admin/photo/add')}}" method="post" enctype="multipart/form-data" >
                        {{ csrf_field() }}



                        <div class="form-group">
                            <label for="exampleInputEmail1">照片名称</label>
                            <input type="text" class="form-control"  name="name" maxlength="7" onkeyup="ck(this)" required>
                            <span>还可以输入</span> <span id="span" style="color: red;font-size: 25px ;">7</span><span>字</span>
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">照片介绍</label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">图片本体</label>
