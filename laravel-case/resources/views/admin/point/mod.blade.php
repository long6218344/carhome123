        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal"  action="/admin/point/update/{{$list->typeid}}" method="post" >
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input name="name" type="text" class="col-xs-10 col-sm-5" value="{{$list->name}}"/>
                            </div>
                        </div>
                        <div class="space-4"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input name="value" type="text" class="col-xs-10 col-sm-5" value="{{$list->value}}"/>
                            </div>
                        </div>
