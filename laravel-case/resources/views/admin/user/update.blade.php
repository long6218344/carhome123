        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    @foreach($user as $v)
                    <form class="form-horizontal" role="form" action="/admin/user/newdate/{{$v->uid}}" method="post" name="reg"
                        ...
                        {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" id="form-field-2" name="icon" class="col-xs-10 col-sm-5" MAX_FILE_SIZE="4096000"/>
                            ...
                            {{--<div class="form-group">--}}
                                ...
                                {{--<div class="col-sm-9">--}}
                                    {{--<input type="text" id="form-field-1" name="address" class="col-xs-10 col-sm-5" value=""/>--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" name="phone" class="col-xs-10 col-sm-5" value="{{$v->phone}}"/>
                                    <div id="regphone"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="radio" name="sex" value="1" {{$v->sex ==1?'checked':""}}/>　男　　　　
                                    <input type="radio" name="sex" value="2" {{$v->sex == 2?'checked':""}}/>　女
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" name="email" class="col-xs-10 col-sm-5" value="{{$v->email}}"/>
                                    <div id="regemail"></div>
                                </div>
                            </div>
                            ...
                            <div class="demo" style="margin-left:370px;">
                                <p>
                                    ...
                                    <input type="date" name="birthday" value="{{$v->birthday}}">
                                </p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="radio" name="status" value="1" {{$v->status == 1?'checked':''}} />　在线　　　
                                    <input type="radio" name="status" value="2" {{$v->status == 2?'checked':''}} />　离线
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea cols="52" rows="3" name="userdetails" value="">{{$v->userdetails}}</textarea>
                                </div>
                            </div>
